...
March - May, 2017 
@brief Simulate the matter power spectra   
"""
import numpy as np
...
# Bias in quadrupole
bias=raw_input("Do you want to introduce a bias in que quadrupole? (y/n) ")
if bias == 'y':
    A = 0.784
else:
    A = 1.
...
#------------------------------------------------------------------------------- 
print "Introducing and subtracting shot noise ... "
Nmean1=1.0
...
#                            Define Multipoles
#-------------------------------------------------------------------------------
print "Computing monopole and quadrupole ..."
...
for i in range(Nbin-1):
    ...
    p2_kbin_1[i] = 5./A*np.sum( (p_est_kmu[i,:] - Shot1) *Legendre2) * step_mu

# Plot estimated and theoretic monopole and quadrupole
plt.figure()    
...
print "The running took ", end-start, " s"
